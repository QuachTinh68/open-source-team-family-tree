...
FamilyTree._defaultConfig = function(e) {
    ...
    if (!FamilyTree.LAZY_LOADING || this.isVisible)
        if (FamilyTree.LAZY_LOADING || this._initialized || (this._setInitialSizeIfNotSet(), 0 != this.width() && 0 != this.height())) {
            ...
            this.manager.read(e, this.width(), this.height(), n, t, i, (function(n) {
                if (!a.notifierUI.show(n.notif))
                    if (!1 !== a.config.lazyLoading || !0 !== e || t === FamilyTree.action.exporting) {
                        t != FamilyTree.action.exporting && (a.nodes = n.nodes, a.visibleNodeIds = n.visibleNodeIds, a.roots = n.roots), a.editUI.fields = n.allFields;
                        var l = {
                            defs: ""
                        };
                        ...
                        for (var m = 0; m < n.visibleNodeIds.length; m++) {
                            var p = n.nodes[n.visibleNodeIds[m]],
                                h = a._get(p.id);
                            FamilyTree.RENDER_LINKS_BEFORE_NODES && (o += a.ui.link(p, a, s, n.bordersByRootIdAndLevel, n.nodes, t)), o += a.ui.node(p, h, n.animations, a.config, void 0, void 0, void 0, t, s, a)
                        }
                        for (m = 0; m < n.visibleNodeIds.length; m++) {
                            p = n.nodes[n.visibleNodeIds[m]];
                            FamilyTree.RENDER_LINKS_BEFORE_NODES || (o += a.ui.link(p, a, s, n.bordersByRootIdAndLevel, n.nodes, t)), o += a.ui.expandCollapseBtn(a, p, a._layoutConfigs, t, s)
                        }
                        l = {
                            content: o,
                            res: n
                        };
                        if (FamilyTree.events.publish("render", [a, l]), o = l.content, n = l.res, o += a.ui.lonely(a.config), t !== FamilyTree.action.exporting) {
                            t !== FamilyTree.action.centerNode && t !== FamilyTree.action.insert && t !== FamilyTree.action.expand && t !== FamilyTree.action.collapse && t !== FamilyTree.action.update || (c = d), t === FamilyTree.action.init && null != d && (c = d), a.response = n;
                            ...
                            })), a._initialized || (a._initialized = !0, a.filterUI.update(), FamilyTree.events.publish("init", [a])), !a._loaded && n && n.nodes && Object.keys(n.nodes).length && (a._loaded = !0)
                        } else {
                            var T = n.boundary,
                                b = T.maxX - T.minX,
                                v = T.maxY - T.minY,
    ...
    if (!FamilyTree.isNEU(t) && t.length)
        if (i) {
            ...
            var d = null;
            Array.isArray(i.pids) && (1 != i.pids.length && console.error("addChildAndPartnerNodes partnerData.pids has to have one partner"), d = this.get(i.pids[0]), Array.isArray(d.pids) || (d.pids = []), d.pids.push(i.id), l.push(d));
            var c = {
                addNodesData: [i],
                updateNodesData: l,
                removeNodeId: null
    ...
    var n, l, o;
    return "left" == a ? n = e.leftNeighbor ? e.x + (e.leftNeighbor.x + e.leftNeighbor.w - e.x) / 2 : e.x - i.siblingSeparation / 2 : "right" == a && (n = e.rightNeighbor ? e.x + e.w + (e.rightNeighbor.x - (e.x + e.w)) / 2 : e.x + e.w + i.siblingSeparation / 2), t.push([n, t[t.length - 1][1]]), t.push([n, e.y - i.levelSeparation / 3]), l = t[t.length - 1][1], o = n, r.p = n, r.q = l, r.r = o, r
}, FamilyTree._addPointBottom = function(e, t, i, r, a) {
    var n, l, o;
    return "left" == a ? n = e.leftNeighbor ? e.x + (e.leftNeighbor.x + e.leftNeighbor.w - e.x) / 2 : e.x - i.siblingSeparation / 2 : "right" == a && (n = e.rightNeighbor ? e.x + e.w + (e.rightNeighbor.x - (e.x + e.w)) / 2 : e.x + e.w + i.siblingSeparation / 2), t.push([n, t[t.length - 1][1]]), t.push([n, e.y + e.h + i.levelSeparation / 3]), l = t[t.length - 1][1], o = n, r.p = n, r.q = l, r.r = o, r
}, FamilyTree._addPointLeft = function(e, t, i, r, a) {
    var n, l = t[t.length - 1][0];
    "bottom" == a ? n = e.rightNeighbor ? e.y + e.h + (e.rightNeighbor.y - (e.y + e.h)) / 2 : e.y + e.h + i.siblingSeparation / 2 : "top" == a && (n = e.leftNeighbor ? e.y + (e.leftNeighbor.y + e.leftNeighbor.h - e.y) / 2 : e.y - i.siblingSeparation / 2), t.push([t[t.length - 1][0], n]), t.push([e.x - i.levelSeparation / 3, n]), l = t[t.length - 1][0];
    var o = n;
    return r.p = l, r.q = n, r.s = o, r
}, FamilyTree._addPointRight = function(e, t, i, r, a) {
    var n, l = t[t.length - 1][0];
    "bottom" == a ? n = e.rightNeighbor ? e.y + e.h + (e.rightNeighbor.y - (e.y + e.h)) / 2 : e.y + e.h + i.siblingSeparation / 2 : "top" == a && (n = e.leftNeighbor ? e.y + (e.leftNeighbor.y + e.leftNeighbor.h - e.y) / 2 : e.y - i.siblingSeparation / 2), t.push([t[t.length - 1][0], n]), t.push([e.x + e.w + i.levelSeparation / 3, n]), l = t[t.length - 1][0];
    var o = n;
    return r.p = l, r.q = n, r.s = o, r
    ...
    this.obj.element.querySelector("[data-add-more-fields-btn]").addEventListener("click", (function(e) {
        ...
        a.focus(), a.nextElementSibling.addEventListener("click", (function(e) {
            ...
            if (FamilyTree.isNEU(i) || n) a.focus();
                ...
                a.parentNode.parentNode.parentNode.removeChild(a.parentNode.parentNode), t.parentNode.insertAdjacentHTML("beforebegin", l.html), t.style.display = "", FamilyTree.input.init(t.parentNode.previousSibling), document.getElementById(l.id).focus()
            }
        }))
    ...
    var n, l = this.obj.config.editForm.readOnly,
    ...
    for (var s in a = o.menu) {
        var d = a[s].icon,
            c = a[s].text;
        void 0 === d && (d = FamilyTree.icon[s] ? FamilyTree.icon[s](24, 24, "#7A7A7A") : ""), "function" == typeof c && (c = c()), "function" == typeof d && (d = d()), l += "<div " + FamilyTree.attr.item + '="' + s + '">' + d + "<span>&nbsp;&nbsp;" + c + "</span></div>"
    }
    if ("" != l) {
        if (this.wrapper = document.createElement("div"), this.wrapper.className = "bft-family-menu", this.wrapper.style.left = "-99999px", this.wrapper.style.top = "-99999px", this.wrapper.innerHTML = l, this.obj.element.appendChild(this.wrapper), null == t) {
        ...
        for (var f = this.wrapper.getElementsByTagName("div"), u = 0; u < f.length; u++) {
            (s = f[u]).addEventListener("click", (function(e) {
                var t, l = this.getAttribute(FamilyTree.attr.item);
                ...
                } else "remove" === l ? n.obj.removeNode(i, null, !0) : "svg" === l ? n.obj.exportSVG({
                    filename: "FamilyTree.svg",
                    expandChildren: !1,
                    nodeId: i
                }) : "pdf" === l ? n.obj.exportPDF({
                    filename: "FamilyTree.pdf",
                    expandChildren: !1,
                    nodeId: i
                }) : "png" === l ? n.obj.exportPNG({
                    filename: "FamilyTree.png",
                    expandChildren: !1,
                    nodeId: i
                }) : "csv" === l ? n.obj.exportCSV({
                    nodeId: i
    ...
    if (!FamilyTree.isNEU(a.nodeCircleMenuButton)) {
        ...
        if (FamilyTree.isNEU(h) || h.getAttribute(FamilyTree.attr.control_node_circle_menu_wrraper_id) != e) {
            ...
            for (var y = 0, g = Object.keys(f.menu).length, T = 2 * a.nodeCircleMenuButton.radius + 4, b = 2 * Math.PI * T, v = b / g - (2 * a.nodeCircleMenuButton.radius + 2); v < 0;) T += 8, v = (b = 2 * Math.PI * T) / g - (2 * a.nodeCircleMenuButton.radius + 2);
    ...
    n.className = "bft-ripple-container", e.addEventListener("mousedown", (function(t) {
        var i, r, a, n, l;
        return this, r = document.createElement("span"), a = this.offsetWidth, i = this.getBoundingClientRect(), l = t.pageX - i.left - a / 2, n = "top:" + (t.pageY - i.top - a / 2) + "px; left: " + l + "px; height: " + a + "px; width: " + a + "px;", e.rippleContainer.appendChild(r), r.setAttribute("style", n)
    ...
    var r = e.getBoundingClientRect(),
        ...
        l = r.left - a.left,
        o = r.top - a.top;
    return r.top + n.height > a.top + a.height && (o -= n.height), r.left - n.width < a.left && (l += n.width), {
        x: l,
        y: o
    }
    ...
    var a, n, l = (new DOMParser).parseFromString(t, "text/xml").getElementsByTagName("text")[0],
        ...
        for (var F = 1, x = 1; x < g.length; x++) {
            ...
            if (b.firstChild.data += " " + g[x], b.getComputedTextLength() > c) {
                if (b.firstChild.data = b.firstChild.data.slice(0, _), F++, a && F > a) {
                    ...
                    break
                }(b = document.createElementNS(p, "tspan")).setAttributeNS(null, "x", o), b.setAttributeNS(null, "y", s + T * y), b.setAttributeNS(null, "text-anchor", d), v = document.createTextNode(g[x]), b.appendChild(v), h.appendChild(b), y++
            }
        }
        var k = "";
    ...
    for (var r = [], a = 0; a < t.length; a++)
        ...
        var l = e.indexOf(r[a]); - 1 != l && e.splice(l, 1)
    }
    t.length && e.push(t[0])
    ...
    FamilyTree._downloadFile("text/csv;charset=utf-8;", "\ufeff" + l.content, l.options.filename, l.options.openInNewTab, l.ext)
    ...
    if (!1 === FamilyTree.events.publish("exportend", [this, l])) return !1;
    FamilyTree._downloadFile("application/xml", l.content, l.options.filename, l.options.openInNewTab, l.ext)
    ...
    if (-1 == e.indexOf("id") || -1 == e.indexOf("pid")) {
        ...
        a.setAttribute("id", "bft-sampleDialog"), a.style.height = "260px", a.style.width = "400px", a.style.background = "white", a.style.border = "0.5px solid grey", a.style.position = "fixed", a.style.overflow = "hidden", a.style.zIndex = "99", n.setAttribute("id", "title"), n.style.backgroundColor = "#e5e5e5", n.style.fontWeight = "bold", n.style.color = "rgb(122, 122, 122)", n.style.height = "20px", n.style.padding = "3px 0 0 7px", o.setAttribute("id", "close"), o.style.cursor = "pointer", o.style.position = "absolute", o.style.color = "rgb(122, 122, 122)", o.style.fontWeight = "bold", o.style.top = "2px", o.style.zIndex = 100, l.setAttribute("id", "content"), l.style.padding = "2px", n.innerHTML = "Import Organizational Chart Data", o.innerHTML = "&times;";
        var s = document.createElement("HR");
        s.style.height = "0.1px", s.style.backgroundColor = "#aeaeae", s.style.border = "none", s.style.margin = "0", a.appendChild(n), a.appendChild(s), l.appendChild(i), a.appendChild(l), a.appendChild(o), document.body.appendChild(a), FamilyTree._importCenter(a), o.style.left = a.offsetWidth - 20 + "px";
    ...
    for (var o = t.target; o != e;) {
        ...
        if (o.hasAttribute(FamilyTree.attr.c_link_from)) return void FamilyTree.events.publish("clink-click", [this, {
            from: o.getAttribute(FamilyTree.attr.c_link_from),
            to: o.getAttribute(FamilyTree.attr.c_link_to),
            event: t
        }]);
        if (o.hasAttribute(FamilyTree.attr.s_link_from)) return void FamilyTree.events.publish("slink-click", [this, {
    ...
    if (this.config.mouseScrool != FamilyTree.action.ctrlZoom || t.ctrlKey) {
        var i = this,
            ...
            d = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
                setTimeout(e, 20)
            };
        t.preventDefault();
        var c = t.delta || t.wheelDelta;
        void 0 === c && (c = -t.detail), c = Math.max(-1, Math.min(1, c)), l += -c * a, r || function e() {
            r = !0;
            var t = (l - o) / n;
    ...
    if (n.draggable) {
        ...
        f.setAttribute("transform", "matrix(1,0,0,1," + (y + T.x) + "," + (g + T.y) + ")"), f.style.opacity = .7;
        var b = function(e, t) {
                if (null != e) {
                ...
                if (h) {
                    ...
                    if (s.left || s.right || s.up || s.down) {
                        ...
                        l.moveStart(s, (function(e) {
                            u[4] = v + e.x, u[5] = x + e.y, h.x = _ - e.xWithoutScale, h.y = w - e.yWithoutScale, i.x = k - e.xWithoutScale, i.y = S - e.yWithoutScale, f.setAttribute("transform", "matrix(" + u.toString() + ")")
                        }))
                    } else {
                        for (l.moveEnd(), p.classList && (p.classList.add("bft-cursor-grab"), p.classList.remove("bft-cursor-move"), p.classList.remove("bft-cursor-nodrop"), p.classList.remove("bft-cursor-copy")), b(c, m), c = null, m = null; null != r && r != p;) {
                        ...
                        if (null != c) {
                            ...
                            for (var I = l.getNode(c), N = FamilyTree.getStParentNodes(I), A = 0; A < N.length; A++) {
                        ...
                        var M = (i.x - h.x) / d,
                            L = (i.y - h.y) / d;
                        if (u[4] = y + M, u[5] = g + L, !e._dragEventFired && (Math.abs(i.x - h.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - h.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === FamilyTree.events.publish("drag", [l.nodeCircleMenuUI, {
                            from: C,
                            menuItem: n,
                            menuItemName: a
            ...
            F = function(t) {
                ...
                var r = l.getNode(c);
                FamilyTree.events.publish("drop", [l.nodeCircleMenuUI, {
                    from: s.id,
                    to: r.id,
                    menuItem: n,
                    menuItemName: a,
                    event: t
                }]), b(c, m), p.removeChild(f), l._gragStartedId = null
            };
                ...
                if (c) {
                    ...
                    if (g.left || g.right || g.up || g.down) {
                        ...
                        s.moveStart(g, (function(e) {
                            m[4] = b + e.x, m[5] = v + e.y, c.x = F - e.xWithoutScale, c.y = x - e.yWithoutScale, i.x = _ - e.xWithoutScale, i.y = w - e.yWithoutScale, u.setAttribute("transform", "matrix(" + m.toString() + ")")
                        }))
                    } else {
                        if (s.moveEnd(), d.classList && (d.classList.add("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), y(l, o), l = null, o = null, s.config.enableDragDrop)
                            for (; null != r && r != d;) {
                                if (r.hasAttribute && r.hasAttribute(FamilyTree.attr.node_id)) {
                        ...
                        if ("draging" == l && (l = null, o = null), null != l) {
                            ...
                            for (var S = s.getNode(l), C = FamilyTree.getStParentNodes(S), I = 0; I < C.length; I++) {
                                ...
                                N && (N.style.opacity = .1)
                            }!s.canUpdateLink(n.id, l) && d.classList ? (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-copy"), d.classList.add("bft-cursor-nodrop")) : d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.add("bft-cursor-copy"), d.classList.remove("bft-cursor-nodrop"))
                        }
                        var A = (i.x - c.x) / f,
                            E = (i.y - c.y) / f;
                        if (m[4] = p + A, m[5] = h + E, !e._dragEventFired && (Math.abs(i.x - c.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - c.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === FamilyTree.events.publish("drag", [s, k, t]) && T(), e._dragEventFired = !0;
                        u.setAttribute("transform", "matrix(" + m.toString() + ")")
                    }
                }
            },
            T = function(t) {
                if (s.moveEnd(), d.classList && (d.classList.remove("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), d.removeEventListener(i.move, g), d.removeEventListener(i.up, T), i.leave && d.removeEventListener(i.leave, T), n.id == l || null == l) return e._dragEventFired && FamilyTree.events.publish("drop", [s, n.id, void 0, u, t]), d.removeChild(u), void(s._gragStartedId = null);
                var r = s.getNode(l);
                if (!1 === FamilyTree.events.publish("drop", [s, n.id, r.id, u, t])) return y(l, o), d.removeChild(u), void(s._gragStartedId = null);
    ...
    if (e) {
        if (!this._moveInterval) {
            ...
            FamilyTree.isNEU(i) && (i = FamilyTree.anim.inSin), FamilyTree.isNEU(r) && (r = 3e3), this._moveInterval = setInterval((function() {
                ...
                e.left ? (o++, c.x = o * FamilyTree.MOVE_STEP / l, c.xWithoutScale = o * FamilyTree.MOVE_STEP) : e.right && (o++, c.x = -o * FamilyTree.MOVE_STEP / l, c.xWithoutScale = -o * FamilyTree.MOVE_STEP), e.up ? (s++, c.y = s * FamilyTree.MOVE_STEP / l, c.yWithoutScale = s * FamilyTree.MOVE_STEP) : e.down && (s++, c.y = -s * FamilyTree.MOVE_STEP / l, c.yWithoutScale = -s * FamilyTree.MOVE_STEP);
                var m = i((10 * d - 10) / r);
    ...
    var r = this.getPointerElement(),
        ...
        n = a.x / t + e[0] - 16 / t,
        l = a.y / t + e[1] - 16 / t;
    r.style.display = "inherit", r.setAttribute("transform", "matrix(0,0,0,0," + n + "," + l + ")"), FamilyTree.animate(r, {
        transform: [0, 0, 0, 0, n, l],
        opacity: 0
    }, {
        transform: [1 / t, 0, 0, 1 / t, n, l],
        opacity: 1
    ...
    o.innerHTML += s.html, this.xBtn = o.querySelector("[data-input-btn]"), this.xBtn.style.display = "none", this.searchTableWrapper = document.createElement("div"), o.appendChild(this.searchTableWrapper);
    var d = e.getSvg().nextSibling;
    this.obj.element.insertBefore(o, d), FamilyTree.input.init(o), this.input = document.getElementById(s.id), this.xBtn.addEventListener("click", (function(e) {
    ...
    if (e) {
        if (e.hasAttribute("data-search-item-id")) {
            ...
            if (this.input.value != FamilyTree.SEARCH_HELP_SYMBOL) 0 != FamilyTree.events.publish("searchclick", [this.obj, t]) && this.obj.center(t);
    ...
    for (var r = this.obj.element.querySelectorAll("[data-search-item-id]"), a = 0; a < r.length; a++) r[a].addEventListener("click", (function() {
    ...
    for (var t in this._searchFieldsAbbreviation) e += `<tr data-search-item-id="${t}" style="height: 50px;"><td class="bft-search-image-td" style="text-align: center;">${t}</td><td class="bft-search-text-td">${this._searchFieldsAbbreviation[t]}</td></tr>`;
    return e += "</table>"
    ...
    null == l && (l = FamilyTree.local), l._setPositions(n, i.layoutConfigs, (function(t) {
        ...
        i.state && i.action == FamilyTree.action.init && (l = i.state.adjustify), i.action == FamilyTree.action.exporting ? l = i._fixAdjustForExport : i._fixAdjustForExport = l;
        for (var o = {
                minX: null,
                minY: null,
                maxX: null,
    ...
    if (FamilyTree.manager._initNode(t, i, s, r, d, c, m), t.isAssistant && (n[t.pid] || (n[t.pid] = []), n[t.pid].push(t.id)), t.subLevels > 0 && l.push(t.id), FamilyTree.MIXED_LAYOUT_FOR_NODES_WITH_COLLAPSED_CHILDREN && !t.isAssistant && t.parent) {
        ...
        }(FamilyTree.MIXED_LAYOUT_ALL_NODES && h.length > FamilyTree.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN && h.length == t.parent.childrenIds.length - f - u || !FamilyTree.MIXED_LAYOUT_ALL_NODES && h.length > FamilyTree.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN) && (o[t.pid] = h)
    }
    ...
    for (var s = [], d = FamilyTree._addDottedLines(i), c = 0; c < d.length; c++) {
        ...
        FamilyTree.isNEU(p.ppid) || (u.ppid = p.ppid), FamilyTree.isNEU(p.stpid) || (u.stpid = p.stpid), null != i.orderBy && (u.order = FamilyTree.manager._getOrderFieldValue(p, i.orderBy)), e[p.id] = u, s.push(p.id)
    }
    ...
    if (FamilyTree.manager.__createNodes(o, s, t, r, a, n, d, e), null != t.roots) {
        ...
        for (var c = 0; c < t.roots.length; c++) {
            ...
            if (m && r == FamilyTree.action.centerNode) {
                ...
                for (var h = o[a.id];
                    (null != h.pid || null != h.stpid) && h != m;) h = null == h.pid && null != h.stpid ? o[h.stpid] : o[h.pid];
                p == h && (m = p)
            }
            if (m) {
                for (var f = !1, u = 0; u < s.length; u++)
                    ...
                    if (!FamilyTree.isNEU(m.pid))(H = (T = o[m.pid]).childrenIds.indexOf(m.id)) > -1 && T.childrenIds.splice(H, 1);
                    s.push(m)
                }
            }
        }
    ...
    if (r == FamilyTree.action.init && t.expand && t.expand.nodes && null == l)
        for (c = 0; c < t.expand.nodes.length; c++) {
            ...
            ae = r == FamilyTree.action.expand ? a.ids : a.expandIds;
            for (c = 0; c < ae.length; c++)
                for (var T = o[(g = o[ae[c]]).pid]; T;) y.push(T.id), null == T.pid && null != T.stpid ? (T = o[T.stpid]).min = !1 : T = o[T.pid]
        } else if (r == FamilyTree.action.centerNode) {
        for (var b = o[a.id]; b;) {
            if (y.push(b.id), a.options.parentState === FamilyTree.COLLAPSE_PARENT_NEIGHBORS && b)
                for (c = 0; c < b.childrenIds.length; c++) {
                    (R = o[b.childrenIds[c]]).collapsed = !0
                }
        ...
        if (a.options.childrenState === FamilyTree.COLLAPSE_SUB_CHILDRENS)
            for (c = 0; c < b.childrenIds.length; c++) {
                (F = o[b.childrenIds[c]]).collapsed = !1;
        ...
        for (g = o[a.insertedNodeId]; g;) y.push(g.id), null == g.pid && null != g.stpid ? (g = o[g.stpid]).min = !1 : g = o[g.pid];
    var x = [],
        _ = {},
        w = [],
        k = {},
        S = [];
    for (c = 0; c < s.length; c++) FamilyTree.manager._iterate(s[c], s[c], o, 0, x, _, w, k, "", y, S, e);
    ...
    for (c = 0; c < S.length; c++) {
        ...
        var C = [],
            ...
            O = [],
            U = [];
        for (v = 0; v < g.children.length; v++) {
            (R = g.children[v]).isAssistant ? C.push(R.id) : -1 != R.tags.indexOf("right-partner") ? (R.isPartner = 1, R.children = [], I.push(R.id)) : -1 != R.tags.indexOf("left-partner") ? (R.isPartner = 2, R.children = [], N.push(R.id)) : -1 == R.tags.indexOf("partner") || E % 2 ? -1 != R.tags.indexOf("partner") && E % 2 ? (R.isPartner = 2, R.children = [], N.push(R.id), E++) : R.parentPartner ? (A[R.parentPartner.id] || (A[R.parentPartner.id] = []), A[R.parentPartner.id].push(R.id)) : C.push(R.id) : (R.isPartner = 1, R.children = [], I.push(R.id), E++)
        }
        g.children = [];
        var B = [];
        for (v = 0; v < I.length; v++) {
            A[(R = o[I[v]]).id] ? g.children.push(R) : g.children.splice(0, 0, R);
            for (var P = 0; P < R.childrenIds.length; P++) B.push(R.childrenIds[P])
        }
        var D = [];
        for (v = 0; v < N.length; v++) {
            A[(R = o[N[v]]).id] ? g.children.push(R) : g.children.splice(0, 0, R);
            for (P = 0; P < R.childrenIds.length; P++) D.push(R.childrenIds[P])
        }
        for (v = 0; v < D.length; v++) {
            (R = o[D[v]]).collapsed || (R.parentPartner = R.parent, R.parent = g, R.isChildOfPartner = !0, g.children.push(R))
        }
        for (v = N.length - 1; v >= 0; v--)
            if (A[N[v]])
                for (u = 0; u < A[N[v]].length; u++) g.children.push(o[A[N[v]][u]]), M++, -1 == U.indexOf(N[v]) && U.push(N[v]);
        ...
        for (v = 0; v < I.length; v++)
            if (A[I[v]])
                for (u = 0; u < A[I[v]].length; u++) g.children.push(o[A[I[v]][u]]), L++, -1 == O.indexOf(I[v]) && O.push(I[v]);
        for (v = 0; v < B.length; v++) {
            (R = o[B[v]]).collapsed || (R.parentPartner = R.parent, R.parent = g, R.isChildOfPartner = !0, g.children.push(R))
        }
        g.partnerSeparation = Math.max(U.length, O.length) * t.partnerChildrenSplitSeparation + t.minPartnerSeparation, C.length || !M || L ? C.length || M || !L ? C.length || 1 != M || 1 != L ? C.length || M || L ? !C.length || M || L ? C.length && (M || L) ? g.hasPartners = 7 : g.hasPartners = 1 : g.hasPartners = 6 : g.hasPartners = 5 : g.hasPartners = 4 : g.hasPartners = 3 : g.hasPartners = 2
    }
    for (c = 0; c < w.length; c++) {
        var z = i[(g = o[w[c]]).lcn ? g.lcn : "base"];
        for (v = 0; v < g.subLevels; v++) {
            var H, j = new FamilyTree.node(g.id + "_sub_level_index_" + v, g.pid, [], "subLevel");
            if (FamilyTree.manager._initDinamicNode(j, g.lcn), T = g.parent)(H = T.children.indexOf(g)) > -1 && (T.children.splice(H, 1), T.children.splice(H, 0, j)), j.children.push(g), j.parent = T, g.parent = j, o[j.id] = j
        }
    }
    for (var $ in _) {
        (T = o[$]).hasAssistants = !0;
        j = new FamilyTree.node(T.id + "_split_assitant_0", T.id, ["assistant"], "split");
        FamilyTree.manager._initDinamicNode(j, T.lcn, !0), o[j.id] = j;
        var X = [];
        for (v = T.children.length - 1; v >= 0; v--) {
            (R = T.children[v]).isAssistant ? (R.parent = null, T.children.splice(v, 1), X.splice(0, 0, R.id)) : R.isPartner || (R.parent && k[R.parent.id] && j && R.parent.id != j.id && (Object.defineProperty(k, j.id, Object.getOwnPropertyDescriptor(k, R.parent.id)), delete k[R.parent.id]), R.parent = j, j.children.unshift(R), T.children.splice(v, 1))
        }
        if (X.length % 2) {
            var Y = o[X[X.length - 1]],
                q = new FamilyTree.node(Y.id + "_mirror", T.pid, [], "mirror");
            FamilyTree.manager._initDinamicNode(q, Y.lcn, !0), Y._m = q.id, q.isAssistant = !0, q.w = Y.w, q.h = Y.h, o[q.id] = q, X.splice(X.length - 1, 0, q.id)
        }
        var V = 1;
        for (v = X.length - 1; v >= 0; v--)
            if (v % 2 && v != X.length - 1) {
                var W = new FamilyTree.node(T.id + "_split_assitant_" + V, T.pid, [], "split");
                FamilyTree.manager._initDinamicNode(W, T.lcn, !0), o[W.id] = W, X.splice(v, 0, W.id), V++
            } else v % 2 && X.splice(v, 0, j.id);
        ...
        if (w.length) {
            ...
            if (re) {
                ...
                for (var $ in k) {
                    ...
                    for (c = 0; c < ae.length; c++) {
                        var ce = ae[c];
                        (null === de || w.has(ce)) && (de = o[ce].parent.id, se || FamilyTree.isNEU(o[ce].subLevels) || (se = o[ce].subLevels > 0)), ne[de] || (ne[de] = []), ne[de].push(ce), se && (oe[de] = $, le[de] || (le[de] = []), le[de].push(ce))
                    }
                }
                for (var $ in k = {}, le)
                    if (le[$].length > FamilyTree.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN) {
                        var me = oe[$];
                        for (c = o[me].children.length - 1; c >= 0; c--) {
                            R = o[me].children[c];
                            le[$].has(R.id) && o[me].children.splice(c, 1)
                        }
                    } for (var $ in ne) ne[$].length > FamilyTree.MIXED_LAYOUT_IF_NUMBER_OF_CHILDREN_IS_MORE_THEN && (k[$] = ne[$])
            }
        }
        for (var $ in k) {
            for (var pe = T = o[$]; pe.isSplit;) pe = o[pe.pid];
            for (; pe.isSubLevel;) pe = o[pe.pid];
            if ((z = i[T.lcn ? T.lcn : "base"]).layout > 0 || te)
                if (ie.pnode = T, ie.layout = z.layout, ie.childrenIds = k[$], ie.lastChildrenPidIds = k, FamilyTree.events.publish("node-layout", [e, ie]), FamilyTree.events.publish("layout", [ie]), ie.layout == FamilyTree.layout.mixed) {
                    var he = ie.childrenIds;
                    for (c = he.length - 1; c >= 0; c--) {
                        T = (R = o[he[c]]).parent, R.layout = FamilyTree.layout.mixed;
                        for (v = T.children.length - 1; v >= 0; v--)
                            if (R.id == T.children[v].id) {
                                T.children.splice(v, 1);
                                break
                            } if (c > 0) {
                            var fe = o[he[c - 1]];
                            R.parent = fe, R.layout = FamilyTree.layout.mixed, fe.children.push(R)
                        } else T.children.push(R)
                    }
                } else if (ie.layout > 1) {
                j = new FamilyTree.node(T.id + "_split_0", pe.id, [], "split");
                FamilyTree.manager._initDinamicNode(j, T.lcn), o[j.id] = j, j.layout = ie.layout;
                var ue = [];
                for (c = ie.childrenIds.length - 1; c >= 0; c--) {
                    for (R = o[ie.childrenIds[c]], v = 0; v < T.children.length; v++) T.children[v].id == R.id && T.children.splice(v, 1);
                    if (R.parent = null, R.layout = ie.layout, ie.layout != FamilyTree.layout.treeRightOffset && ie.layout != FamilyTree.layout.treeRight || ue.splice(0, 0, R.id), ie.layout > 2) {
                        var ye = new FamilyTree.node(R.id + "_mirror", pe.id, [], "mirror");
                        FamilyTree.manager._initDinamicNode(ye, R.lcn), ye.layout = ie.layout, o[ye.id] = ye, ue.splice(0, 0, ye.id)
                    }
                    ie.layout != FamilyTree.layout.treeRightOffset && ie.layout != FamilyTree.layout.treeRight && ue.splice(0, 0, R.id)
                }
                for (V = 1, v = ue.length - 1; v >= 0; v--)
                    if (v % 2 && v != ue.length - 1) {
                        W = new FamilyTree.node(T.id + "_split_" + V, pe.id, [], "split");
                        FamilyTree.manager._initDinamicNode(W, T.lcn), W.layout = ie.layout, o[W.id] = W, ue.splice(v, 0, W.id), V++
                    } else v % 2 && ue.splice(v, 0, j.id);
                for (v = 0; v < ue.length; v += 3) {
                    G = null;
                    0 == v && (G = T);
                    J = o[ue[v]], K = o[ue[v + 1]], Z = o[ue[v + 2]];
                    0 != v && (G = o[ue[v - 3]]), 0 == v || K || (G = o[ue[v - 2]]), J.parent = G, G.children.push(J), K && (0 != v && (G = o[ue[v - 2]]), K.parent = G, G.children.push(K)), Z && (0 != v && (G = o[ue[v - 1]]), Z.parent = G, G.children.push(Z))
                }
            }
        }
    }
    ...
    return FamilyTree.events.publish("nodes-initialized", [e, ie]), {
        nodes: ie.nodes,
        roots: ie.roots,
        rootList: d
    }
    ...
    for (i = 0; i < e.nodes.length; i++)
        for (var r in e.nodes[i]) r !== FamilyTree.ID && r !== FamilyTree.TAGS && r !== FamilyTree.NODES && r !== FamilyTree.PID && r !== FamilyTree.STPID && (e.nodeBinding[r] || t.has(r) || t.push(r));
    return t
    ...
    if (g.top = o - r.padding, g.left = l - r.padding, g.bottom = n + r.padding - t / F, g.right = a + r.padding - e / F, g.maxX = a, g.minX = l, g.maxY = n, g.minY = o, 0 == d.length || null == s && !f && r.align == FamilyTree.CENTER) {
        var x = Math.ceil(e / F),
            _ = Math.ceil(t / F),
            w = 0,
            k = 0;
        if (x - 2 * r.padding >= a - l) switch (w = (a + l) / 2 - x / 2, r.orientation) {
            case FamilyTree.orientation.right:
            case FamilyTree.orientation.right_top:
                w = (l - a) / 2 - x / 2
        ...
        if (_ - 2 * r.padding >= n - o) switch (k = (n + o) / 2 - _ / 2, r.orientation) {
            case FamilyTree.orientation.bottom:
            case FamilyTree.orientation.bottom_left:
                k = (o - n) / 2 - _ / 2
        } else switch ((k = -(_ / 2 - (n - o) / 2)) > -r.padding && (k = -r.padding), r.orientation) {
            case FamilyTree.orientation.bottom:
            case FamilyTree.orientation.bottom_left:
    ...
    if (FamilyTree.manager._isVisible(e, i, r, a)) {
        ...
        else if (a != FamilyTree.action.update && a != FamilyTree.action.insert || !o) a !== FamilyTree.action.exporting && a !== FamilyTree.action.init && -1 == s.indexOf(e.id) && (d[0].push(e.id), d[1].push({
            opacity: 0
        }), d[2].push({
            opacity: 1
        }));
        ...
        null != c && null != c.x && null != c.y && (c.x == e.x && c.y == e.y || (d[0].push(e.id), d[1].push({
    ...
    e.isPartner ? e.sl = r - 1 : e.sl = r, null == a[t.id] && (a[t.id] = {}), null == a[t.id][e.sl] && (a[t.id][e.sl] = {
        ...
        maxX: null,
        maxY: null
    }), e.layout || FamilyTree._setMinMaxXY(e, a[t.id][e.sl]), r++;
        ...
        for (var i = [], r = 0; r < e.groupDottedLines.length; r++) {
            ...
            if (!i.has(n))
                for (var l = 0; l < t.length; l++)
                    if (t[l].id == a.rootId) {
                        (c = JSON.parse(JSON.stringify(t[l]))).id = `balkan_group_dotted_${a.rootId}_balkan_id_${t[l].id}`, c.pid = void 0, c.stpid = t[l].id, t.push(c), i.push(n), t[l].tags || (t[l].tags = []), t[l].tags.push("group-dotted-lines"), t[l].tags.push("group-dotted-lines-" + n);
                        break
                    } for (l = 0; l < t.length; l++)
                if (t[l].id == a.from) {
                    if ((c = JSON.parse(JSON.stringify(t[l]))).id = `balkan_group_dotted_${a.rootId}_balkan_id_${t[l].id}`, c.pid = `balkan_group_dotted_${a.rootId}_balkan_id_${a.to}`, c.tags) {
                        var o = c.tags.indexOf("group-dotted-lines"); - 1 != o && c.tags.splice(o, 1)
                    }
    ...
    if (e.dottedLines.length)
        for (r = 0; r < e.dottedLines.length; r++) {
            ...
            for (l = 0; l < t.length; l++)
                if (t[l].id == d.from) {
                    var c;
                    if ((c = JSON.parse(JSON.stringify(t[l]))).id = `balkan_dotted_${d.rootId}_balkan_id_${t[l].id}`, d.rootId == d.to ? c.pid = d.to : c.pid = `balkan_dotted_${d.rootId}_balkan_id_${d.to}`, c.tags || (c.tags = []), c.tags.push("bft-dotted-connector"), d.tags)
    ...
    if (null != i.orderBy && c)
        for (var T in c) c[T].sort((function(t, r) {
            var a = e[t].order,
                n = e[r].order;
            return "number" == typeof a || "number" == typeof n ? (null == a && (a = -1), null == n && (n = -1), i.orderBy.desc ? n - a : a - n) : "string" == typeof a || "string" == typeof n ? (null == a && (a = ""), null == n && (n = ""), i.orderBy.desc ? n.localeCompare(a) : a.localeCompare(n)) : void 0
        }));
    ...
    for (var y = 0; y < c.pids.length; y++) {
        ...
        if (g) {
            g.pid = c.id;
            var T = a ? a[g.id] : null;
            if (T && (g.collapsed = T.collapsed, g.min = T.min), l == FamilyTree.action.init && (g.min = FamilyTree._getMin(g, s)), o && m && T && o.id == c.id ? T.hasPartners && 1 == m.isPartner ? g.tags.push("left-partner") : T.hasPartners && 2 == m.isPartner || 1 == m.isPartner ? g.tags.push("right-partner") : 2 == m.isPartner ? g.tags.push("left-partner") : g.tags.push("partner") : T && 2 == T.isPartner ? g.tags.push("left-partner") : T && 1 == T.isPartner ? g.tags.push("right-partner") : g.tags.push("partner"), !FamilyTree.isNEU(g) && i[g.id])
    ...
    if (t[e])
        for (b = 0; b < t[e].length; b++) FamilyTree.manager._iterateFT(t[e][b], t, i, r, a, n, l, o, s);
    if (i[e])
        for (b = 0; b < i[e].length; b++) FamilyTree.manager._iterateFT(i[e][b], t, i, r, a, n, l, o, s)
}, FamilyTree.manager.getAllFields = function(e) {
    var t = [FamilyTree.TAGS];
    for (var i in e.nodeBinding) t.push(e.nodeBinding[i]);
    for (i = 0; i < e.nodes.length; i++)
    ...
    menuButton: '<div style="position:absolute;right:{p}px;top:{p}px; cursor:pointer;" ' + FamilyTree.attr.control_export_menu + '=""><svg fill="#2c67f2" width="35px" height="35px" viewBox="0 -1.5 35 35" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#2c67f2"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><title>download1</title><path d="M29.426 15.535c0 0 0.648-8.743-7.361-9.74-6.866-0.701-8.955 5.679-8.955 5.679s-2.067-1.988-4.873-0.364c-2.51 1.55-2.067 4.388-2.067 4.388s-5.576 1.083-5.576 6.768c0.125 5.677 6.055 5.734 6.055 5.734h11.351l-5-5h3v-6h4v6h3l-5 5h10.467c0 0 5.52 0.006 6.295-5.395 0.369-5.906-5.336-7.070-5.336-7.070z"></path></g></svg></div>',
    padding: [50, 20, 35, 20],
    ...
    node: function(e, t, i, r, a, n, l, o, s, d) {
        ...
        for (var h in l) {
            ...
            if (p.value = f, p.element = c[h], p.name = u, p.field = h, !1 !== FamilyTree.events.publish("field", [d, p]) && null != p.value && null != p.value && null != p.element) {
                ...
                m += T = T.replaceAll("{ew}", e.w - (e.padding ? e.padding[1] : 0)).replaceAll("{cw}", e.w / 2).replaceAll("{randId}", FamilyTree.randomId()).replaceAll("{randId2}", FamilyTree.randomId())
            }
        }
        var b = FamilyTree._getPosition(i, e, a, n),
            v = "node";
        Array.isArray(e.tags) && e.tags.length && (v += " " + e.tags.join(" ")), e.layout && (v += " tree-layout");
        var F = "";
        e.lcn && (F = 'lcn="' + e.lcn + '"');
        var x = FamilyTree.nodeOpenTag.replace("{lcn}", F).replace("{id}", e.id).replace("{class}", v).replace("{sl}", e.sl).replace("{level}", e.level).replace("{x}", b.x).replace("{y}", b.y),
            _ = FamilyTree._getOpacity(i, e);
        return m = (x = x.replace("{opacity}", _)) + (m += FamilyTree.ui.nodeBtns(r, e, o, c, d)) + FamilyTree.grCloseTag
    },
    ...
    link: function(e, t, i, r, a, n) {
        ...
        e.layout > 0 && (c = o.mixedHierarchyNodesSeparation / 2);
        var m = 0,
        ...
        for (u = 0; u < e.children.length; u++) {
            ...
            if (y.isChildOfPartner) switch (o.orientation) {
                ...
                if ((F || y.layout > 1) && y.rightNeighbor && y.rightNeighbor.isSplit) switch (o.orientation) {
                    case FamilyTree.orientation.top:
                    case FamilyTree.orientation.top_left:
                    case FamilyTree.orientation.bottom:
                    case FamilyTree.orientation.bottom_left:
                ...
                } else if ((x || y.layout > 1) && y.leftNeighbor && y.leftNeighbor.isSplit) switch (o.orientation) {
                    case FamilyTree.orientation.top:
                    case FamilyTree.orientation.top_left:
                    case FamilyTree.orientation.bottom:
                    case FamilyTree.orientation.bottom_left:
    ...
    _roundedEdge: function(e, t, i, r, a, n) {
        var l, o, s, d = FamilyTree.LINK_ROUNDED_CORNERS,
            c = 0;
        return e == i && e == a || t == r && t == n ? (l = s = i, o = c = r) : (e != a && i == a && (l = s = i, o = r, t < n ? c = r + d : t > n && (c = r - d)), e < a && i == a ? i -= d : e > a && i == a && (i += d), t != n && r == n && (l = i, o = c = r, e < a ? s = i + d : e > a && (s = i - d)), t < n && r == n ? r -= d : t > n && r == n && (r += d)), {
            x1: e,
            y1: t,
            x2: i,
            y2: r,
    ...
    _linkTopToBottom: function(e, t, i, r, a) {
        var n, l, o, s, d, c = 0;
        return n = e.x + e.w / 2 + i.linkAdjuster.toX, l = e.y + e.h + i.linkAdjuster.toY, s = o = t.x + t.w / 2 + i.linkAdjuster.fromX, d = t.y + i.linkAdjuster.fromY, {
            xa: n,
            ya: l,
            xb: n,
            yb: c = e.rightNeighbor && e.rightNeighbor.isAssistant && "split" == t.templateName ? e.rightNeighbor.y + e.rightNeighbor.h + r : "split" == e.templateName && (t.isAssistant || t.layout > 1) ? d : "split" == t.templateName ? l + r : null != a ? a : d - r,
            xc: o,
            yc: c,
            xd: s,
            yd: d,
    ...
    _linkBottomToTop: function(e, t, i, r, a) {
        var n, l, o, s, d, c = 0;
        return n = e.x + e.w / 2 + i.linkAdjuster.toX, l = e.y + i.linkAdjuster.toY, s = o = t.x + t.w / 2 + i.linkAdjuster.fromX, d = t.y + t.h + i.linkAdjuster.fromY, {
            xa: n,
            ya: l,
            xb: n,
            yb: c = e.rightNeighbor && e.rightNeighbor.isAssistant && "split" == t.templateName ? e.rightNeighbor.y - r : "split" == e.templateName && (t.isAssistant || t.layout > 1) ? d : "split" == t.templateName ? l - r : null != a ? a : d + r,
            xc: o,
            yc: c,
            xd: s,
            yd: d,
    ...
    _linkRightToLeft: function(e, t, i, r, a) {
        var n, l, o, s, d, c, m = 0;
        return n = e.x + i.linkAdjuster.toX, l = e.y + e.h / 2 + i.linkAdjuster.toY, d = t.x + t.w + i.linkAdjuster.fromX, c = s = t.y + t.h / 2 + i.linkAdjuster.fromY, o = l, 90, {
            xa: n,
            ya: l,
    ...
    _linkLeftToRight: function(e, t, i, r, a) {
        var n, l, o, s, d, c, m = 0;
        return n = e.x + e.w + i.linkAdjuster.toX, l = e.y + e.h / 2 + i.linkAdjuster.toY, d = t.x + i.linkAdjuster.fromX, c = s = t.y + t.h / 2 + i.linkAdjuster.fromY, o = l, 270, {
            xa: n,
            ya: l,
    ...
    _linkPpLeft: function(e, t, i, r, a, n) {
        var l = e.ppnodes[i.id],
            ...
            m = c.y;
        return o = c.mid, FamilyTree.ui._linkLeftToRight({
            x: d,
            y: m,
            w: 0,
            h: 0
    ...
    _linkPpRight: function(e, t, i, r, a, n) {
        var l = e.ppnodes[i.id],
            ...
            c = FamilyTree.ui.__linkPpLeftRight(e, t, i, o, s, l),
            m = c.y;
        return o = c.mid, FamilyTree.ui._linkRightToLeft({
            x: d,
            y: m,
            w: 0,
            h: 0
    ...
    __linkPpBottomTop: function(e, t, i, r, a, n) {
        var l = 0;
        return 1 == n.isPartner ? (l = n.x - t.partnerSeparation / 2 + e.indexes[i.id] * e.partnerChildrenSplitSeparation - (e.rightIds.length - 1) * e.partnerChildrenSplitSeparation / 2, e.lastLeft && l < e.lastLeft.x + e.lastLeft.w / 2 ? l < i.x + i.w / 2 ? r -= (e.indexes[i.id] + 1) * a : r -= (e.rightIds.length - e.indexes[i.id]) * a : l < i.x + i.w / 2 ? r += (e.rightIds.length - e.indexes[i.id]) * a : r += (e.indexes[i.id] + 1) * a) : 2 == n.isPartner && (l = n.x + n.w + t.partnerSeparation / 2 + e.indexes[i.id] * e.partnerChildrenSplitSeparation - (e.leftIds.length - 1) * e.partnerChildrenSplitSeparation / 2, e.firstRight && l > e.firstRight.x + e.firstRight.w / 2 ? l < i.x + i.w / 2 ? r -= (e.indexes[i.id] + 1) * a : r -= (e.leftIds.length - e.indexes[i.id]) * a : l < i.x + i.w / 2 ? r += (e.leftIds.length - e.indexes[i.id]) * a : r += (e.indexes[i.id] + 1) * a), {
            x: l,
            mid: r
        }
    },
    __linkPpLeftRight: function(e, t, i, r, a, n) {
        var l = 0;
        return 1 == n.isPartner ? (l = n.y - t.partnerSeparation / 2 + e.indexes[i.id] * e.partnerChildrenSplitSeparation - (e.rightIds.length - 1) * e.partnerChildrenSplitSeparation / 2, e.lastLeft && l < e.lastLeft.y + e.lastLeft.h / 2 ? l < i.y + i.h / 2 ? r -= (e.indexes[i.id] + 1) * a : r -= (e.rightIds.length - e.indexes[i.id]) * a : l < i.y + i.h / 2 ? r += (e.rightIds.length - e.indexes[i.id]) * a : r += (e.indexes[i.id] + 1) * a) : 2 == n.isPartner && (l = n.y + n.h + t.partnerSeparation / 2 + e.indexes[i.id] * e.partnerChildrenSplitSeparation - (e.leftIds.length - 1) * e.partnerChildrenSplitSeparation / 2, e.firstRight && l > e.firstRight.y + e.firstRight.h / 2 ? l < i.y + i.h / 2 ? r -= (e.indexes[i.id] + 1) * a : r -= (e.leftIds.length - e.indexes[i.id]) * a : l < i.y + i.h / 2 ? r += (e.leftIds.length - e.indexes[i.id]) * a : r += (e.indexes[i.id] + 1) * a), {
            y: l,
            mid: r
        }
    }
    ...
    var a = this.getViewBox().slice(0),
        ...
        l = a[2],
        o = a[3];
    !0 === e ? (a[2] = a[2] / FamilyTree.SCALE_FACTOR, a[3] = a[3] / FamilyTree.SCALE_FACTOR) : !1 === e ? (a[2] = a[2] * FamilyTree.SCALE_FACTOR, a[3] = a[3] * FamilyTree.SCALE_FACTOR) : (a[2] = a[2] / e, a[3] = a[3] / e), t || (t = [50, 50]), a[0] = n[0] - (a[2] - l) / (100 / t[0]), a[1] = n[1] - (a[3] - o) / (100 / t[1]);
    ...
    var a, n, l, o = e.element.querySelector("#bft-ppdf-size"),
    ...
    o.value = t.format, s.value = t.landscape, d.value = t.scale, c.value = t.margin, m.value = t.header, p.value = t.footer, FamilyTree.animate(e.element.querySelector("#bft-ppdf-btns"), {
        margin: [0, 0, 0, -250]
    }, {
        margin: [0, 0, 0, 0]
    }, 300, FamilyTree.anim.outSin, (function() {
    ...
    })), FamilyTree.pdfPrevUI._showHide(o, s, d), o.addEventListener("change", (function() {
    ...
    for (var s = o.querySelector("svg"), d = e.element.querySelector("#bft-ppdf-content"), c = 0; c < a.length; c++) {
        ...
        var f = r.footer;
        a[c].footer && (f = a[c].footer), f && (f = f.replace("{current-page}", c + 1).replace("{total-pages}", a.length)), a[c].html ? p.write(FamilyTree._exportHtml(a[c].html, t.styles, r, a[c].innerSize.w, a[c].innerSize.h, h, f, e.config.mode)) : (s.setAttribute("viewBox", a[c].vb), p.write(FamilyTree._exportHtml(o.innerHTML, t.styles, r, a[c].innerSize.w, a[c].innerSize.h, h, f, e.config.mode)));
    ...
    for (var i = "", r = 0; r < this.config.clinks.length; r++) {
        var a = this.config.clinks[r],
            n = e.getNode(a.from),
            l = e.getNode(a.to);
        if (n && -1 != t.res.visibleNodeIds.indexOf(n.id) && (l && -1 != t.res.visibleNodeIds.indexOf(l.id))) {
            var o = n.x,
                s = n.y,
                d = l.x,
                c = l.y,
            ...
            switch (this.config.orientation) {
                case FamilyTree.orientation.top:
                case FamilyTree.orientation.top_left:
                    h <= f ? (g = 1, m.x = h + n.w / 10, p.x = f - l.w / 10) : (g = -1, m.x = h - n.w / 10, p.x = f + l.w / 10), s == c ? (g = 1, m.y = s, p.y = c) : s > c ? (m.y = s, p.y = c + l.h) : (m.y = s + n.h, p.y = c);
                    break;
                case FamilyTree.orientation.bottom:
                case FamilyTree.orientation.bottom_left:
                    h <= f ? (g = -1, m.x = h + n.w / 10, p.x = f + l.w / 10) : (g = 1, m.x = h - n.w / 10, p.x = f + l.w / 10), s == c ? (g = -1, m.y = s + n.h, p.y = c + l.h) : s > c ? (m.y = s, p.y = c + l.h) : (m.y = s + n.h, p.y = c);
                    break;
                case FamilyTree.orientation.left:
                case FamilyTree.orientation.left_top:
                    u <= y ? (g = -1, m.y = u + n.h / 5, p.y = y + l.h / 5) : (g = 1, m.y = u - n.h / 5, p.y = y + l.h / 5), o == d ? (g = -1, m.x = o, p.x = d) : o > d ? (m.x = o, p.x = d + l.w) : (m.x = o + n.w, p.x = d);
                    break;
                case FamilyTree.orientation.right:
                case FamilyTree.orientation.right_top:
                    u <= y ? (g = 1, m.y = u + n.h / 5, p.y = y + l.h / 5) : (g = -1, m.y = u - n.h / 5, p.y = y + l.h / 5), o == d ? (g = 1, m.x = o + n.w, p.x = d + l.w) : o > d ? (m.x = o, p.x = d + l.w) : (m.x = o + n.w, p.x = d)
            }
            var T = _(m, p, g),
                b = a.template;
            b || (b = "orange");
            var v = FamilyTree.clinkTemplates[b];
            if (a.label) {
                var F = FamilyTree.clinkLabelPosition(a, m, p, T);
                i += v.label.replace("{x}", F.x).replace("{y}", F.y).replace("{val}", a.label)
            }
            var x = "M" + m.x + "," + m.y + "C" + m.x + "," + m.y + " " + T.x + "," + T.y + " " + p.x + "," + p.y;
            i += ("<g " + FamilyTree.attr.c_link_from + '="{from}" ' + FamilyTree.attr.c_link_to + '="{to}">').replace("{from}", n.id).replace("{to}", l.id) + v.link.replaceAll("{d}", x) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + x + '" />', i += FamilyTree.grCloseTag
        }
    ...
    function n(t, n, l) {
        ...
        if (t.sl == n.sl) switch (d = n, p.orientation) {
            ...
            for (; null == d;) {
                var T = !1,
                    ...
                    v = b.leftNeighbor,
                    F = b.rightNeighbor;
                if (b.id == n.id ? d = b : FamilyTree._intersects(b, u, e.config) && (u = FamilyTree._addPoint(b, s, e.config, u, c), T = !0), b.id != n.id) {
                    for (; v;) {
                        if (v.id == n.id) {
                            d = v;
                            break
                        }
                        FamilyTree._intersects(v, u, e.config) && (u = FamilyTree._addPoint(v, s, e.config, u, c), T = !0), v = v.leftNeighbor
                    }
                    for (; F;) {
                        if (F.id == n.id) {
                            d = F;
                        ...
                        FamilyTree._intersects(F, u, e.config) && (u = FamilyTree._addPoint(F, s, e.config, u, c), T = !0), F = F.rightNeighbor
                    }
                }
                if (!T) {
                    var x = s[s.length - 1][0],
                        _ = 0;
                    if (b.parent) {
                        f = p.levelSeparation, b.parent.layout && (f = p.mixedHierarchyNodesSeparation);
                        var w = e.manager.bordersByRootIdAndLevel[g.id][b.parent.sl];
                        switch (p.orientation) {
                            case FamilyTree.orientation.top:
                            case FamilyTree.orientation.top_left:
                                _ = w.maxY + f * (2 / 3);
        ...
        var E = s.join(" ");
        if (o.label) {
            var M = h.label.replace("{x}", I.x).replace("{y}", I.y).replace("{val}", o.label),
                L = FamilyTree._getLabelSize(M),
                O = -L.height / 2;
            switch (p.orientation) {
                case FamilyTree.orientation.bottom:
                case FamilyTree.orientation.bottom_left:
            ...
            i += h.label.replace("{x}", I.x).replace("{y}", I.y + O).replace("{val}", o.label)
        }
        var U = t.id,
            B = n.id;
        l && (U = n.id, B = t.id), i += ("<g " + FamilyTree.attr.s_link_from + '="{from}" ' + FamilyTree.attr.s_link_to + '="{to}">').replace("{from}", U).replace("{to}", B) + h.link.replaceAll("{d}", E) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + E + '" />', i += FamilyTree.grCloseTag
    }
    ...
    if (e.config.miniMap) {
        if (e.manager.action != FamilyTree.action.move) {
            ...
            var r, a, n, l, o = e.element.querySelector('[data-id="mini-map-focus"]'),
                s = !1,
                d = null;
            o.onmousedown = function(e) {
                var t, n, l, d = o.getBoundingClientRect(),
                    c = d.left,
                    m = d.top;
                if (r = parseInt(e.clientX - c), a = parseInt(e.clientY - m), t = a, n = (r - FamilyTree.miniMap._settings._translateX) / FamilyTree.miniMap._settings._scale, l = (t - FamilyTree.miniMap._settings._translateY) / FamilyTree.miniMap._settings._scale, n > i[0] && n < i[0] + i[2] && l > i[1] && l < i[1] + i[3]) return e.preventDefault(), e.stopPropagation(), void(s = !0)
                ...
                if (s) {
                    ...
                    }), 300), FamilyTree.miniMap._drawRectSelectorCanvas(e, i), r = n, a = l
                }
    ...
    ! function e(t, n) {
        if (Array.isArray(n))
            for (var l = 0; l < n.length; l++) e(t, n[l]);
        else {
            ...
            for (l = 0; l < n.stChildrenIds.length; l++) r++, a.includes(n.id) || (1 == r ? i.fillStyle = FamilyTree.miniMap.colors[0] : 2 == r ? i.fillStyle = FamilyTree.miniMap.colors[1] : 3 == r && (i.fillStyle = FamilyTree.miniMap.colors[2]), i.beginPath(), i.fillRect(n.x, n.y, n.w, n.h), i.strokeRect(n.x, n.y, n.w, n.h), a.push(n.id)), e(t, t.getNode(n.stChildrenIds[l])), r--;
    ...
    var a = t[0],
        ...
        l = t[2],
        o = t[3];
    r.lineWidth = .5 / FamilyTree.miniMap._settings._scale, r.strokeStyle = FamilyTree.miniMap.focusStroke, r.globalAlpha = 1, r.clearRect(a, n, l, o), r.strokeRect(a, n, l, o)
    ...
    right: void 0,
    bottom: "padding"
}, FamilyTree.miniMap.draggable = !0, FamilyTree._search = {}, FamilyTree._search.search = function(e, t, i, r, a, n, l) {
    var o = [],
        s = t.toLowerCase(),
        d = s.split(" ");
    if (l && d.length > 1) {
    ...
    if (o) {
        ...
        o.writeToIndexedDB && (d.id = o.name, FamilyTree.idb.put(d, (function(e) {
    ...
    if (e) {
        ...
        if (e.readFromUrlParams) {
            ...
            if (n.has(a.paramScale) && n.has(a.paramX) && n.has(a.paramY) && n.has(a.paramExp) && n.has(a.paramMin) && n.has(a.paramAdjustify)) {
                ...
                (m = [])[0] = s, m[1] = d, m[2] = t / o, m[3] = i / o, l.vb = m, l.scale = o, l.x = s, l.y = d, l.roots = null, n.has(a.paramRoots) && (l.roots = n.get(a.paramRoots).split("*")), l.exp = n.get(a.paramExp).split("*"), l.min = n.get(a.paramMin).split("*");
    ...
    if (n || l) {
        ...
        if (o && (null != o.timer && clearInterval(o.timer), null != o.timerBack && clearInterval(o.timerBack), l.setAttribute("transform", "matrix(" + o.transformStart.toString() + ")"), FamilyTree._magnify[e] = null), i) l = l.cloneNode(!0), this.getSvg().appendChild(l);
    ...
    var T = [];
    for (g = 0; g < o.length; g++)(o[g].fid == c.id && FamilyTree.isNEU(o[g].mid) || o[g].mid == c.id && FamilyTree.isNEU(o[g].fid)) && (o[g].fid == c.id ? o[g].mid = "_ft_partner_for_single_child" : o[g].mid == c.id && (o[g].fid = "_ft_partner_for_single_child"), m.push(o[g]), T.push(o[g].id));
    if (T.length) {
        var b = {
        ...
        "male" == c.gender ? (b.templateName = "wife", b._ft_partnerData.gender = "female") : "female" == c.gender && (b.templateName = "husband", b._ft_partnerData.gender = "male"), c.pids.push(b.id), m.push(b)
    }
    var v = {
        nodes: m,
        node: c
    };
    FamilyTree.events.publish("node-tree-menu-show", [this, v]), v.nodes.push(v.node), this.config.nodes = v.nodes, c = this.get(e);
    var F = this;
    ...
    if (this.instance.config.filterBy) {
        ...
        if (null != this.filterBy)
            for (var o in e)
                if (this.filterBy[o])
                    for (var s in e[o]) this.filterBy[o][s] && (e[o][s] = this.filterBy[o][s]);
        this.filterBy = e;
        var d = this,
            c = this.instance.element.querySelector("[data-filter]");
        c && c.parentNode.removeChild(c), (c = document.createElement("div")).setAttribute("data-filter", ""), c.style.position = "absolute", c.setAttribute("class", "bft-filter"), c.style.top = this.instance.config.padding + "px", c.style.left = this.instance.config.padding + "px";
        var m = "";
        for (var o in this.filterBy) m += `<div data-filter-field="${o}">${o}</div>`;
        c.innerHTML = `<div>${m}</div>`, c.addEventListener("click", (function(e) {
                        ...
                        if (t) {
                            ...
                            if (e.target.hasAttribute("data-all")) {
                                for (var r = e.target.parentNode.parentNode.querySelectorAll("input"), a = 0; a < r.length; a++)
                                    if (r[a] != e.target)
                                        for (var n in r[a].checked = e.target.checked, d.filterBy[i]) d.filterBy[i][n].checked = e.target.checked
                            } else if (null != d.filterBy[i][this.name] && (d.filterBy[i][this.name].checked = this.checked), this.checked)
                                for (var l = d.instance.config.nodes, o = 0; o < l.length; o++)
                                    if (l[o][i] == this.name)
                                        for (var s = l[o]; s;)
                                            if (FamilyTree.isNEU(s.stpid)) s = FamilyTree.isNEU(s.pid) ? null : d.instance._get(s.pid);
                                            else if ((s = d.instance._get(s.stpid))[i]) {
                                var c = e.target.parentNode.parentNode.querySelector('[name="' + s[i] + '"]');
                                c ? (c.checked = this.checked, d.filterBy[i][s[i]].checked = this.checked) : console.error('Cannot find element with selector: [name="' + s[i] + '"]')
                            }
                            d.instance.draw()
                        }
                    }))
                }
                l.style.display = "block", e.target.classList.add("filter-field-selected"), (n = document.createElement("div")).classList.add("close"), n.innerHTML = "x", n.setAttribute("data-filter-close", ""), e.target.parentNode.appendChild(n)
            }
    ...
    e.children.length > 0 && (i.c = FamilyTree.remote._convertToIdArray(e.children)), e.stChildren.length > 0 && (i.v = FamilyTree.remote._convertToIdArray(e.stChildren)), null != e.layout && 0 != e.layout && (i.l = e.layout), e.isAssistant && (i.a = 1), e.isSplit && (i.s = e.isSplit), e.isMirror && (i.im = e.isMirror), e.padding && (i.q = e.padding), e.lcn && (i.k = e.lcn), e.stContainerNodes && (i.b = FamilyTree.remote._convertToIdArray(e.stContainerNodes)), e._m && (i.m = e._m.id), e.isPartner && (i.i = e.isPartner), e.hasPartners && (i.g = e.hasPartners), e.partnerSeparation && (i.e = e.partnerSeparation), t.push(i);
